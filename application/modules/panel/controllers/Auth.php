	...
	function permissions($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true) {
            $data = array(
				...
				'settings-general' => $this->input->post('settings-general'),
				'settings-orders' => $this->input->post('settings-orders'),
				'settings-invoice' => $this->input->post('settings-invoice'),
				'settings-sms' => $this->input->post('settings-sms'),
				'settings-appearance' => $this->input->post('settings-appearance'),
				'settings-upload_logo' => $this->input->post('settings-upload_logo'),
				'settings-upload_background' => $this->input->post('settings-upload_background'),
				'repair_statuses-index' => $this->input->post('repair_statuses-index'),
				'repair_statuses-add' => $this->input->post('repair_statuses-add'),
				'repair_statuses-edit' => $this->input->post('repair_statuses-edit'),
				'repair_statuses-delete' => $this->input->post('repair_statuses-delete'),
				'repair_statuses-sort' => $this->input->post('repair_statuses-sort'),
            );
        }
