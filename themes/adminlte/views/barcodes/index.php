              ...
              <div class="panel-body" style="padding: 15px 35px 15px 35px;">
                <div class="form-group">
                  ...
                  <div class="radio col-md-12">
                    ...
                    <div class="radio radio-replace">
                      <input class="radioSet" type="radio" value="cus" id="radio_cus" onclick="mainLoad.radioSet(this.value);" name="radioSet">
              ...
              <div class="panel-body" style="padding: 15px 35px 15px 35px;">
                <div class=" col-md-12">
                  <div class="form-group">
                    ...
                    <input onkeyup="mainLoad.viewPrint();" id="txtName" type="text" class="form-control" placeholder="<?=lang('ProductNamePlaceholder');?>" value="<?=lang('ProductName');?>" />
                  </div>
                  <div class="form-group">
                    <div class="checkbox checkbox-replace">
                    ...
                    <input onkeyup="mainLoad.viewPrint();" id="txtBarcode" type="text" class="form-control" placeholder="<?=lang('BarcodePlaceholder');?>" value="1234567890S" />
                  </div>
                  <div class="form-group">
                    <div class="checkbox checkbox-replace">
                    ...
                    <input onkeyup="mainLoad.viewPrint();" id="txtPrice" type="text" class="form-control" placeholder="<?=lang('PricePlaceholder');?>" value="0 <?=$settings->currency;?>" />
                  </div>
                  <div class="form-group">
                    <div class="checkbox checkbox-replace">
                    ...
                    <textarea onkeyup="mainLoad.viewPrint();" id="txtDetail" class="form-control" rows="5" placeholder="<?=lang('ProductDescription');?>"><?=lang('ProductDescription');?></textarea>
                  </div>
                </div>
              </div>
            </div>
