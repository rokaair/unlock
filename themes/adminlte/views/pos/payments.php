<div class="modal-content">
    <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel"><?= lang('view_payments').' ('.lang('sale').' '.lang('reference').': '.sprintf("%04d", $inv->id).')'; ?></h4>
                            ...
                            <td>
                                <div class="text-center">
                                    <a href="#" class="po"
                                       ...
                                       data-content="<p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' id='<?= $payment->id ?>' href='<?= base_url('panel/pos/delete_payment/' . $payment->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn po-close'><?= lang('no') ?></button>"
                                       rel="popover"><i class="fas fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                    <?php }
