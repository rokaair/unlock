...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        <?php if ($inv) { ?>
        localStorage.setItem('podate', '<?= date('d/m/y h:i:s', strtotime($inv->date))?>');
...
<div class="box">
            <div class="box-header">
              <h3 class="box-title"><i class="fa-fw fa fa-edit"></i><?= ('edit_purchase'); ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
...
<script type="text/javascript" src="<?= $assets; ?>dist/js/pages/purchases.js"></script>