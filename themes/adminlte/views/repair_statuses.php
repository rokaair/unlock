<script type="text/javascript">
	$(document).ready(function() {
		<?php if($this->Admin || $this->GP['repair_statuses-sort']):?>
			$('.todo-list').sortable({
...
<div class="box box-primary">
	<div class="box-header ui-sortable-handle" style="cursor: move;">
	  ...
	  <h3 class="box-title"><?= lang('repair_statuses'); ?></h3>
	</div>
	<div class="box-body">
	...
	<div class="box-footer clearfix no-border">
		<?php if($this->Admin || $this->GP['repair_statuses-add']):?>
