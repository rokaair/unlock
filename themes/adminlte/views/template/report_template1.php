    ...
    <body>
        ...
        <div class="halfinvoice print">
            ...
            <main>
                ...
                <div id="dati" contentEditable="true">
                    ...
                    <div class="col"><b><?= $this->lang->line('reparation_advance');?>:</b> <?=$this->repairer->formatDecimal($db['advance']);?></div>
